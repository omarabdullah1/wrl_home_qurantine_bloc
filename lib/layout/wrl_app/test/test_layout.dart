  ...
  void initState() {
    ...
    Timer.periodic(const Duration(seconds: 15), (timer) {
      ...
      TestCubit.get(context).userPut(
          ...
          isPaired: TestCubit.get(context).isPaired);
    });
    // print(TestCubit.get(context).isInside);
    // print(TestCubit.get(context).IsPaired);
  }

  @override
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: TestCubit.get(context).getRemainingDays(),
                              ...
                              CircularPercentIndicator(
                                ...
                                center: SizedBox(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        '${TestCubit.get(context).remainingDays}',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 60.0,
                                          color: Colors.indigo[900],
